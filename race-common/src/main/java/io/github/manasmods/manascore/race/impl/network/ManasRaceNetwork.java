...
public class ManasRaceNetwork {
    public static void init() {
        ...
        NetworkUtils.registerC2SPayload(RequestRaceAbilityReleasePacket.TYPE,
                RequestRaceAbilityReleasePacket.STREAM_CODEC, RequestRaceAbilityReleasePacket::handle);
