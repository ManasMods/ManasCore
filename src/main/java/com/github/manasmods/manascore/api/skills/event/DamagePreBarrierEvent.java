...
/**
 * This Event is fired by {@link LivingHurtEvent} before the Barrier Attribute takes effect.
...
@Cancelable
public class DamagePreBarrierEvent extends Event {
    @Getter
    ...
    public DamagePreBarrierEvent(LivingHurtEvent event) {
        this.event = event;
