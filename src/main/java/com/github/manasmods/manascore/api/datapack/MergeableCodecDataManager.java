...
public class MergeableCodecDataManager<RAW, FINE> extends SimplePreparableReloadListener<Map<ResourceLocation, FINE>> {
     ...
     * @param codec      A codec that will be used to parse jsons. See <a href="https://gist.github.com/Drullkus/1bca3f2d7f048b1fe03be97c28f87910">drullkus's codec</a> primer for help on creating these.
    ...
    private <PACKET> Consumer<OnDatapackSyncEvent> getDatapackSyncListener(final SimpleChannel channel, final Function<Map<ResourceLocation, FINE>, PACKET> packetFactory) {
        return event -> {
